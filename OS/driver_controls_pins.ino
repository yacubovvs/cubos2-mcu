...
/*
void os_control_reset_debug_last_user_avtivity(){
  last_user_activity = _millis() - 4000 - random(750);
}
*/
...
// Do not change:
boolean os_control_pressStart[] = {false, false, false, false};
boolean os_control_pressEnd[]   = {false, false, false, false};
boolean os_control_press[]      = {false, false, false, false};
...
boolean isPressStart_Left(){
  ...
  boolean isPressStart_Back(){
    return isPressStart(3);
  }
#endif
//
//////////////////////////////////////////////////////////////////////////////