...
bool driver_MTU6050_device_is_horizontally(){
	if(abs(accel_t_gyro.value.x_accel)<4000 && abs(accel_t_gyro.value.y_accel)<4000) return true;
	else return false;
}
